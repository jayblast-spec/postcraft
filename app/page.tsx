...
const product = {"repo":"PostCraft","suite":"Creator / Founder Tools","category":"Content engine","audience":"founders, creators, agencies, and build-in-public operators","promise":"turn raw ideas into platform-native posts with a point of view","inputLabel":"Idea, lesson, or product update","placeholder":"We fixed our Forge quality gate so failures now become reusable lessons","primary":"Craft post","gradient":"from-pink-300 via-rose-300 to-orange-300","metrics":["3 angles","Voice lock","Distribution plan"],"modules":["Hook generator","Narrative spine","Platform variants","Proof receipts","Publishing calendar"],"outputs":["LinkedIn post","X thread outline","CTA options","Repurpose plan"],"pricing":"Free post pack, $19/month Creator, $99/month Studio."} as const;
